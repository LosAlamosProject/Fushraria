...
class Healthbar:
    ...
    def DrawSlider(self):
        ...
        pg.draw.rect(screen, "Gold", (self.X-self.rect_h/2 - 5, self.Y - 5, self.rect_w+10, self.rect_h / 2 + 10))
        ...
        font1 = pg.font.SysFont('Comic Sans MS', math.floor(self.rect_h/2), bold=pg.font.Font.bold)
        img1 = font1.render(str(int(self.per)), True, 'Black')
        screen.blit(img1, (self.X-self.rect_h/2, self.Y - self.rect_h/6.5))

slider = Healthbar(100, 200, 50, 1000, 50)
