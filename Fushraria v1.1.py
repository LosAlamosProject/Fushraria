...
clock = pg.time.Clock()
pg.mixer.init()
pg.mixer.music.load("Mao Zedong Drip (Trap Remix).mp3")
...
while True:
        ...
        if pg.mouse.get_pressed()[2]:
                    if pg.mouse.get_pos()[0] > displayPX + character.W:
                        ...
                        elif pg.mouse.get_pos()[1]<displayPY+32  and world[int(character.posY-character.H/2)//32][(character.posX-character.W//2+32)//32] ==0 and pg.mouse.get_pos()[1] > displayPY: 
                            world[int(character.posY-character.H/2)//32][(character.posX-character.W//2+32)//32] =selectedBlock
                        elif pg.mouse.get_pos()[1]<displayPY+64  and world[int(character.posY-character.H/2+32)//32][(character.posX-character.W//2+32)//32] ==0 and pg.mouse.get_pos()[1] > displayPY+32: 
                            world[int(character.posY-character.H/2+32)//32][(character.posX-character.W//2+32)//32] =selectedBlock
                        elif  world[int(character.posY-character.H/2+64)//32][(character.posX-character.W//2+32)//32] ==0 and pg.mouse.get_pos()[1] > displayPY+64: 
