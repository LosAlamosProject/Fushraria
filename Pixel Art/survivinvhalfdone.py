...
H = 850
XX = (1280 - 620) / 2
L = [pg.image.load(".\\Kramp.png"), pg.image.load(".\\Sekira.png"),pg.image.load(".\\Mac.png"),Block_Dict[1]["texture"], Block_Dict[2]["texture"], Block_Dict[4]["texture"], Block_Dict[5]["texture"], Block_Dict[6]["texture"], 0]
