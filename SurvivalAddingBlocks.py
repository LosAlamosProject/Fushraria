...
H = 850
XX = (1280 - 620) / 2
L = [pg.image.load(".\\Kramp.png"), pg.image.load(".\\Sekira.png"),pg.image.load(".\\Lopata.png"),Block_Dict[1]["texture"], Block_Dict[2]["texture"], Block_Dict[4]["texture"], Block_Dict[5]["texture"], Block_Dict[6]["texture"], 0]
LB = [1,1,1,0,0,0,10,0,0]
...
while True:
                ...
                if pg.mouse.get_pressed()[0]:
                    if pg.mouse.get_pos()[0] > displayPX + character.W:
                        if pg.mouse.get_pos()[1] < displayPY and world[int(character.posY-character.H/2-32)//32][(character.posX-character.W//2+32)//32] !=3:
                            if world[int(character.posY-character.H/2-32)//32][(character.posX-character.W//2+32)//32] == 1 and slot == 1:
                                for i in range(9):
                                    if L[i] == Block_Dict[1]["texture"]:
                                        LB[i] += 1
                                        break
                            elif world[int(character.posY-character.H/2-32)//32][(character.posX-character.W//2+32)//32] == 2 and slot == 3:
                                for i in range(9):
                                    if L[i] == Block_Dict[2]["texture"]:
                                        LB[i] += 1
                                        break
                            elif world[int(character.posY-character.H/2-32)//32][(character.posX-character.W//2+32)//32] == 4 and slot == 3:
                                for i in range(9):
                                    if L[i] == Block_Dict[4]["texture"]:
                                        LB[i] += 1
                                        break
                            elif world[int(character.posY-character.H/2-32)//32][(character.posX-character.W//2+32)//32] == 5 and slot == 2:
                                for i in range(9):
                                    if L[i] == Block_Dict[5]["texture"]:
                                        LB[i] += 1
                                        break
                            elif world[int(character.posY-character.H/2-32)//32][(character.posX-character.W//2+32)//32] == 6:
                                for i in range(9):
                                    if L[i] == Block_Dict[6]["texture"]:
                                        LB[i] += 1
                                        break
        ...
        if pg.mouse.get_pressed()[2]:
                    if pg.mouse.get_pos()[0] > displayPX + character.W:
                        if pg.mouse.get_pos()[1] < displayPY and world[int(character.posY-character.H/2-32)//32][(character.posX-character.W//2+32)//32]  ==0 and LB[invpos] >0:
                            world[int(character.posY-character.H/2-32)//32][(character.posX-character.W//2+32)//32] =selectedBlock
                            if invpos>2:
                                LB[invpos] -=1
                        elif pg.mouse.get_pos()[1]<displayPY+32  and world[int(character.posY-character.H/2)//32][(character.posX-character.W//2+32)//32] ==0 and LB[invpos] >0 and  pg.mouse.get_pos()[1] > displayPY: 
                            world[int(character.posY-character.H/2)//32][(character.posX-character.W//2+32)//32] =selectedBlock
                            if invpos>2:
                                LB[invpos] -=1
                        elif pg.mouse.get_pos()[1]<displayPY+64  and world[int(character.posY-character.H/2+32)//32][(character.posX-character.W//2+32)//32] ==0 and LB[invpos] >0 and  pg.mouse.get_pos()[1] > displayPY+32: 
                            world[int(character.posY-character.H/2+32)//32][(character.posX-character.W//2+32)//32] =selectedBlock
                            if invpos>2:
                                LB[invpos] -=1
                        elif  world[int(character.posY-character.H/2+64)//32][(character.posX-character.W//2+32)//32] ==0 and LB[invpos] >0 and  pg.mouse.get_pos()[1] > displayPY+64: 
                        ...
                        if pg.mouse.get_pos()[1] < displayPY and world[int(character.posY-character.H/2-32)//32][(character.posX-character.W//2)//32] ==0 and LB[invpos] >0:
                             world[int(character.posY-character.H/2-32)//32][(character.posX-character.W//2)//32] = selectedBlock
                             if invpos>2:
                                LB[invpos] -=1
                
                        elif  pg.mouse.get_pos()[1] > displayPY+32 and world[int(character.posY-character.H/2+64)//32][(character.posX-character.W//2)//32] ==0 and LB[invpos] >0: 
