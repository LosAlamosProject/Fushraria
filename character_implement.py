...
def draw(menjansvet, daynightcycle):
    ...
    #Where to turn the craracter
    if LastClick == 1:
        screen.blit(chard,(screen.get_width()//2-32, screen.get_height()//2,character.W, character.H))
    else:
        screen.blit(charl,(screen.get_width()//2-32, screen.get_height()//2,character.W, character.H))
